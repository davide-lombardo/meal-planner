...
router.post('/telegram', async (req, res) => {
  ...
  try {
    ...
    if ('telegramChatId' in config.menuOptions && config.menuOptions.telegramChatId && !chatIds.includes(String(config.menuOptions.telegramChatId))) chatIds.push(String(config.menuOptions.telegramChatId));
